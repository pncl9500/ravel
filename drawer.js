  ...
  for (var i in players) {
    ...
    if(player.aura){
      if(player.auraType == 0){
        ...
        context.arc(width / 2 + (player.pos.x - focus.x) * fov, height / 2 + (player.pos.y - focus.y) * fov, 300/32 * fov, 0, Math.PI * 2, true);
        context.fill();
        context.closePath();
    ...
    context.beginPath();context.fillStyle = "rgb(4, 26, 4,"+player.swampDebuff * 0.8+")";context.arc(width / 2 + (player.pos.x - focus.x) * fov, height / 2 + (player.pos.y - focus.y) * fov, (player.radius+0.5/32) * fov, 0, Math.PI * 2, true);context.fill();context.closePath();
    context.beginPath();context.fillStyle = "rgb(0, 0, 90,"+player.drowningSpeed * 1.2+")";context.arc(width / 2 + (player.pos.x - focus.x) * fov, height / 2 + (player.pos.y - focus.y) * fov, (player.radius+0.5/32) * fov, 0, Math.PI * 2, true);context.fill();context.closePath();
    context.beginPath();context.fillStyle = "rgb(143, 84, 134,"+player.pullEffect * 0.06 * (1/255)+")";context.arc(width / 2 + (player.pos.x - focus.x) * fov, height / 2 + (player.pos.y - focus.y) * fov, (player.radius+0.5/32) * fov, 0, Math.PI * 2, true);context.fill();context.closePath();
